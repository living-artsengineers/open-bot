...
import { termCodes, sharedClient as umClient } from '../soc/umichApi'
...
const mod = host.module('classLookup')

mod.slash('lookup-section', 'Looks up a given course section.', {
  build: br => br.addStringOption((opt) =>
    opt
      .setName('course-code')
...
async function buildEmbed (course: Course, section: Section<true>, term: keyof typeof termCodes): Promise<EmbedBuilder> {
