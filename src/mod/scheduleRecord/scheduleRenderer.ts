...
export class ScheduleRenderer {
  ...
  constructor (private readonly sections: Array<[Section<true>, Course]>) {
  ...
  public async render (filename: string): Promise<void> {
    this.drawBackground()
  ...
  private drawTableOutlineWithLabels (): void {
    const ctx = this.canvas.getContext('2d')
  ...
  private renderMeeting (course: Course, colorIndex: number, section: Section<true>, meeting: Meeting<true>): void {
    const ctx = this.canvas.getContext('2d')
